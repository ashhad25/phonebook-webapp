    ...
    <body style="background-image:url('image.jpg') ; background-position: center; background-size: cover;">
            ...
            <div class="dropdown">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left: 140px;">
                <ul class="navbar-nav ms-auto me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item ms-2">
                    <a class="nav-link active" href="view_user2.php">View all</a><?php echo '<p style="background: grey; float: right; margin-top: -33px; width: 40%; border-radius: 25px; color: black; padding: 1px 8px; border: none; margin-right: -20px;">'.$row.'</p>' ;?>
                  </li>
       ...
       $id = $_SESSION['user_id'];
       $count= 1;
       $query = "SELECT * FROM contactdetails where user_id = $id ORDER BY contact_name ";
        $result = mysqli_query($dbcon,$query);
